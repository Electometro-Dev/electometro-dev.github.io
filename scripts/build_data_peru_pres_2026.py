...
def parse_candidate_header(header_str):
    ...
    If no parentheses present, return header as name and party=None.
    """
...
def map_vote_text_to_value(vote_text):
    ...
    'En contra' -> 0
    'Neutral' -> 0.5
    Numeric strings like '0', '1', '0.5' are parsed as floats.
    Returns None if unknown or empty.
    """
    ...
    # canonical mapping, allow extra words
...
def generate_from_new_structure():
    ...
    Do not drop empty candidate columns, do not skip questions when all cells are missing.
    """
    ...
    raw_dataframe = raw_dataframe.head(12)
